...

{
  ...
  # Greeter — niri is the standard WM
  services.greetd = {
    enable = true;
    settings = {
      default_session = {
  ...
  # Niri — standard Wayland compositor for all hosts
  ...
  users.users.daniel = {
    ...
    openssh.authorizedKeys.keys = [
      ...
      "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIOmu3QXj2b0OkbKPCxS+gIWUXvaI0hq/VX1xa3anlal6 daniel@yoga"
